...
$queryy = "SELECT * FROM uploads ORDER BY date_time DESC";
    ...
    <div class="dashboard-parent">
        ...
        <div class="dashboard-details">
            ...
            <div class="dashboard-details-welcome-log">
                ...
                <button onclick="window.location.href='myPhotos.php'" class="subbtn"><i class='bx bx-photo-album'></i> My Photos</button>
            </div>
        </div>
        <div class="Gallery">
